...
/* 🥊 BANNER CONTAINER: IMAGEN ENCUADRADA (CORREGIDO PARA NO CORTAR LA IMAGEN) 🥊 */
.banner-wrapper {
    position: relative; 
    border-radius: 16px; 
    overflow: hidden; 
...
.banner-container {
    background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.1) 0%, rgba(5, 5, 5, 0.95) 100%), url('{BANNER_PRINCIPAL}');
    background-size: cover; 
    background-position: center top; /* Evita que se corten las cabezas al centrar verticalmente un poco mas arriba */
    min-height: 520px; /* Altura ideal para encuadrar las caras */
    width: 100%;
    display: flex; 
...
# 🛠️ SISTEMA DE BYPASS PROXY PARA IMÁGENES UFC
...
# --- BANNER PRINCIPAL ANIMADO Y CORREGIDO PARA PC (IMAGEN ENCUADRADA) ---
st.markdown("""
...
# --- Page Configuration ---
st.set_page_config(
    page_title="UFC Freedom 250 | Cokemma Edition",
    page_icon="🥊",
    layout="wide",
    initial_sidebar_state="expanded",
)

# --- Official URLs & Fighter Info ---
TRAILER_URL = "[https://youtu.be/iNJIs5bXoAE?si=Lbes9bQDegv6vocd](https://youtu.be/iNJIs5bXoAE?si=Lbes9bQDegv6vocd)"
BANNER_PRINCIPAL = "[https://objetos-xlk.estaticos-marca.com/uploads/2026/04/12/69daeaf5a9090.jpeg](https://objetos-xlk.estaticos-marca.com/uploads/2026/04/12/69daeaf5a9090.jpeg)"
APP_URL = "[https://predicciones-ufc-87c5opnpg9pmnfjm9qqrkr.streamlit.app](https://predicciones-ufc-87c5opnpg9pmnfjm9qqrkr.streamlit.app)"
DEVELOPER_TIKTOK = "@martincampos.mma"
DEVELOPER_URL = "[https://tiktok.com/@martincampos.mma](https://tiktok.com/@martincampos.mma)"

FIGHTER_IMAGES = {
    "Ilia Topuria": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2024-10/TOPURIA_ILIA_L_BELT_10-26.png?itok=0ZnoiqvU](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2024-10/TOPURIA_ILIA_L_BELT_10-26.png?itok=0ZnoiqvU)",
    "Justin Gaethje": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/GAETHJE_JUSTIN_L_BELTMOCK.png?itok=Ec57vAPj](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/GAETHJE_JUSTIN_L_BELTMOCK.png?itok=Ec57vAPj)",
    "Alex Pereira": "[https://gidstats.com/img/fighters/0/0/1-824.png](https://gidstats.com/img/fighters/0/0/1-824.png)",
    "Ciryl Gane": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-01/5/GANE_CIRYL_L_12-07.png?itok=RtxXOv1m](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-01/5/GANE_CIRYL_L_12-07.png?itok=RtxXOv1m)",
    "Sean O'Malley": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/OMALLEY_SEAN_L_01-24.png?itok=GKNy0vLH](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/OMALLEY_SEAN_L_01-24.png?itok=GKNy0vLH)",
    "Aiemann Zahabi": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-01/5/ZAHABI_AIEMANN_L_11-02.png?itok=7oV3Lazp](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-01/5/ZAHABI_AIEMANN_L_11-02.png?itok=7oV3Lazp)",
    "Josh Hokit": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/HOKIT_JOSH_L_01-24.png?itok=q4AaxC15](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-01/HOKIT_JOSH_L_01-24.png?itok=q4AaxC15)",
    "Derrick Lewis": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-07/LEWIS_DERRICK_L_07-12.png?itok=NW56kLpV](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-07/LEWIS_DERRICK_L_07-12.png?itok=NW56kLpV)",
    "Mauricio Ruffy": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-02/RUFFY_MAURICIO_L_01-31.png?itok=I_xrL9e4](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-02/RUFFY_MAURICIO_L_01-31.png?itok=I_xrL9e4)",
    "Michael Chandler": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-04/CHANDLER_MICHAEL_L_04-12.png?itok=a63uTG7H](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-04/CHANDLER_MICHAEL_L_04-12.png?itok=a63uTG7H)",
    "Bo Nickal": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-11/NICKAL_BO_L_11-15.png?itok=H_KDgWwL](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-11/NICKAL_BO_L_11-15.png?itok=H_KDgWwL)",
    "Kyle Daukaus": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-11/DAUKAUS_KYLE_L_11-15.png?itok=9rQVeQfZ](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-11/DAUKAUS_KYLE_L_11-15.png?itok=9rQVeQfZ)",
    "Diego Lopes": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-02/LOPES_DIEGO_L_01-31.png?itok=m_ex383n](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2026-02/LOPES_DIEGO_L_01-31.png?itok=m_ex383n)",
    "Steve Garcia": "[https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-10/GARCIA_STEVE_L_11-01.png?itok=C9aRxxhd](https://wsrv.nl/?url=https://ufc.com/images/styles/athlete_bio_full_body/s3/2025-10/GARCIA_STEVE_L_11-01.png?itok=C9aRxxhd)"
}
...
if not os.path.exists(PELEAS_FILE):
    ...
    pd.DataFrame(initial_peleas).to_csv(PELEAS_FILE, index=False)
...
# --- CSS Styling (Premium Broadcast Theme) ---
st.markdown("""
<style>
@import url('[https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:wght@400;600;800&display=swap](https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:wght@400;600;800&display=swap)');
...
/* Hide specific Streamlit elements for OBS mode */
header {visibility: hidden;}
#MainMenu {visibility: hidden;}
footer {visibility: hidden;}

/* Custom Ticker (ESPN Style) */
.ticker-wrap { 
    width: 100%; 
    background-color: #DC2626; 
    color: white; 
...
/* --- Banner Styling - ENLARGED & ADJUSTED --- */
.banner-wrapper {
    position: relative; 
    border-radius: 16px; 
    overflow: hidden; 
...
/* Tabs Styling - PC Broadcast Optimized */
div[data-baseweb="tab-list"] {
    gap: 12px;
    border-bottom: 3px solid #DC2626; 
    padding-bottom: 0px;
...
/* --- Animations & Screen Shake (BOOM Effect) --- */
@keyframes shake {
    0% { transform: translate(1px, 1px) rotate(0deg); }
    10% { transform: translate(-1px, -2px) rotate(-1deg); }
    20% { transform: translate(-3px, 0px) rotate(1deg); }
...
/* Responsivo para celulares (Mantiene compatibilidad) */
@media (max-width: 768px) {
    .banner-wrapper { min-height: 250px; }
    .fighter-img { width: 110px; height: 110px; }
    .fighter-name { font-size: 1.8rem; }
    .vs-text { font-size: 2.5rem; margin-top: 30px; }
    .weight-class { font-size: 0.9rem; }
...
OPTIONS_METHOD = ["KO/TKO", "Sumisión", "Decisión"]
def get_opciones_round(rondas_max): return [str(i) for i in range(1, rondas_max + 1)] + ["Tarjetas (Decisión)"]

def calculate_leaderboard(df_p, df_preds, liga_filter=None):
    if df_preds.empty: return pd.DataFrame(columns=["Peleador", "Cinturón 🎖️", "Puntos Totales", "Plenos (25pts)", "Aciertos Ganador"])
    if liga_filter and liga_filter.strip().upper() != "GLOBAL":
        df_preds = df_preds[df_preds["liga"].str.upper() == liga_filter.strip().upper()]
        if df_preds.empty: return pd.DataFrame(columns=["Peleador", "Cinturón 🎖️", "Puntos Totales", "Plenos (25pts)", "Aciertos Ganador"])

    scores = {user: {"points": 0, "plenos": 0, "ganadores": 0} for user in df_preds["usuario"].unique()}
    played_fights = df_p[df_p["jugado"] == True]
    
    for _, pred in df_preds.iterrows():
        user = pred["usuario"]
        p_id = int(pred["pelea_id"])
        real_fight_list = played_fights[played_fights["id"] == p_id].to_dict(orient="records")
        if not real_fight_list: continue
        real_p = real_fight_list[0]
        
        real_w, real_m, real_r = real_p["res_winner"], real_p["res_method"], str(real_p["res_round"])
        pred_w, pred_m, pred_r = pred["pred_winner"], pred["pred_method"], str(pred["pred_round"])
        
        if real_w == pred_w:
            fight_points = 10
            scores[user]["ganadores"] += 1
            if real_m == pred_m: fight_points += 5
            if real_r == pred_r: fight_points += 5
            if real_m == pred_m and real_r == pred_r:
                fight_points += 5 
                scores[user]["plenos"] += 1
            scores[user]["points"] += fight_points

    leaderboard_data = []
    for u, stats in scores.items():
        p = stats["points"]
        rank_desc = "En el Pesaje ⚖️"
        if p >= 120: rank_desc = "Campeón Indiscutido 🏆"
        elif p >= 80: rank_desc = "Retador #1 👊"
        elif p >= 40: rank_desc = "Prospecto Letal 🔥"
        elif p > 0: rank_desc = "Peleador Preliminar 🥊"
        leaderboard_data.append([u, rank_desc, p, stats["plenos"], stats["ganadores"]])
        
    df_leaderboard = pd.DataFrame(leaderboard_data, columns=["Peleador", "Cinturón 🎖️", "Puntos Totales", "Plenos (25pts)", "Aciertos Ganador"])
    return df_leaderboard.sort_values(by=["Puntos Totales", "Plenos (25pts)"], ascending=[False, False]).reset_index(drop=True)

def get_fighter_img_url(name):
    return FIGHTER_IMAGES.get(name, f"[https://ui-avatars.com/api/?name=](https://ui-avatars.com/api/?name=){name.replace(' ', '+')}&background=18181b&color=DC2626&size=200&font-size=0.33&bold=true")

def get_stat_value(name, stat_key):
    if name in FIGHTER_STATS: return FIGHTER_STATS[name].get(stat_key, "N/A")
    return "N/A"
...
with st.sidebar:
    st.markdown("""
    <div style="text-align: center; padding: 10px;">
        <img src="[https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/UFC_logo.svg/1024px-UFC_logo.svg.png](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/UFC_logo.svg/1024px-UFC_logo.svg.png)" width="130" style="margin-bottom:15px; filter: drop-shadow(0px 0px 10px rgba(220,38,38,0.8));">
        <h2 style="color: #DC2626; margin-top: 0px; text-transform: uppercase; letter-spacing: 2px;">FIGHT WEEK</h2>
    </div>
    """, unsafe_allow_html=True)
    st.markdown("---")
    
    broadcast_mode = st.checkbox("🎥 Broadcast Mode (Hides UI for OBS)", value=False)
    if broadcast_mode:
        st.markdown("<style>header, #MainMenu, footer {visibility: hidden;}.block-container {padding-top: 1rem; max-width: 95%;}</style>", unsafe_allow_html=True)
        
    st.markdown("---")
    st.markdown("<h3 style='text-align: center; color: white;'>🔗 Invite Friends</h3>", unsafe_allow_html=True)
    st.code(APP_URL, language="text")
    whatsapp_msg = f"🥊 Join Cokemma's broadcast league for UFC FREEDOM 250! Lock in your picks here: {APP_URL}"
    whatsapp_url = f"[https://api.whatsapp.com/send?text=](https://api.whatsapp.com/send?text=){urllib.parse.quote(whatsapp_msg)}"
    st.markdown(f'<a href="{whatsapp_url}" target="_blank" style="text-decoration: none;"><div style="background-color: #25D366; color: white; text-align: center; padding: 12px; border-radius: 8px; font-weight: bold; margin-top: 5px; box-shadow: 0 4px 6px rgba(0,0,0,0.3);">📲 Share on WhatsApp</div></a>', unsafe_allow_html=True)
    st.markdown("<br><br>", unsafe_allow_html=True)
    
    # Developer TikTok badge
    st.markdown(f"""
    <div style="text-align:center; padding: 15px; border-radius: 12px; background: linear-gradient(135deg, #00f2fe 0%, #4facfe 100%); box-shadow: 0 4px 15px rgba(0, 242, 254, 0.3);">
        <p style="color: #000; font-weight: 800; margin: 0; font-size: 0.9rem; text-transform: uppercase;">Official Developer</p>
        <a href="{DEVELOPER_URL}" target="_blank" style="color: #000; text-decoration: none; font-family: 'Bebas Neue', sans-serif; font-size: 2rem; display: block; margin-top: 5px; text-shadow: 1px 1px 2px rgba(255,255,255,0.5);">
            {DEVELOPER_TIKTOK} <span style="font-size:1.2rem;">🎵</span>
        </a>
    </div>
    """, unsafe_allow_html=True)
...
# --- MAIN EVENT BANNER (ENLARGED & ADJUSTED) ---
st.markdown(f"""
<div class="banner-wrapper">
...
# --- NEWS TICKER (Broadcast Style) ---
st.markdown("""
<div class="ticker-wrap">
    <marquee scrollamount="12">🚨 EN VIVO: DIRECTO ESPECIAL COKEMMA | 🥊 ÚLTIMA HORA: Topuria promete un KO brutal en el 1er Round... 💰 MOMIOS: Gaethje paga +450 en Las Vegas, ¿habrá sorpresa hoy?... 🏆 Alex Pereira busca hacer historia en su debut en Peso Pesado... 📊 ¡Cierra tus predicciones ahora y compite contra el chat en el Ránking Global!</marquee>
</div>
""", unsafe_allow_html=True)

# --- MAIN NAVIGATION TABS ---
# Tabs renamed for better user clarity, logic remains based on user variables in code
t_lobby, t_picks, t_stats, t_ranks, t_odds, t_admin = st.tabs(["🏠 LOBBY PRINCIPAL", "📝 PREDICCIONES 🥊", "📊 STATS EN VIVO", "🏆 RÁNKINGS", "🎲 MOMIOS & ANÁLISIS", "🔒 PANEL ADMIN"])
...
with t_lobby:
    ...
    col_n1, col_n2, col_n3 = st.columns(3)
    with col_n1:
        st.markdown("""<a href="[https://www.mma.es/2026/02/25/ufc-white-house-mas-caro/](https://www.mma.es/2026/02/25/ufc-white-house-mas-caro/)" target="_blank" class="news-card" style="background-image: url('[https://www.mma.es/wp-content/uploads/2026/02/UFC-Casa-Blanca.png](https://www.mma.es/wp-content/uploads/2026/02/UFC-Casa-Blanca.png)');"><div class="news-overlay"><p class="news-title">El evento más caro de la historia de UFC</p></div></a>""", unsafe_allow_html=True)
    with col_n2:
        st.markdown("""<a href="[https://www.diariodesantiago.es/deportes/ilia-topuria-peleara-en-la-casa-blanca-contra-justin-gaethje-por-el-titulo-ligero-de-la-ufc-en-una-cartelera-historica/](https://www.diariodesantiago.es/deportes/ilia-topuria-peleara-en-la-casa-blanca-contra-justin-gaethje-por-el-titulo-ligero-de-la-ufc-en-una-cartelera-historica/)" target="_blank" class="news-card" style="background-image: url('[https://www.diariodesantiago.es/wp-content/uploads/2026/03/ilia-topuria-encabeza-la-historica-cartelera-de-ufc-en-la-casa-blanca-vs-justin-gaethje-2026-03-08-ilia-topuria-encabeza-la-historica-cartelera-de-ufc-en-la-casa-blanca-vs-justin-gaethje.jpg](https://www.diariodesantiago.es/wp-content/uploads/2026/03/ilia-topuria-encabeza-la-historica-cartelera-de-ufc-en-la-casa-blanca-vs-justin-gaethje-2026-03-08-ilia-topuria-encabeza-la-historica-cartelera-de-ufc-en-la-casa-blanca-vs-justin-gaethje.jpg)');"><div class="news-overlay"><p class="news-title">Topuria vs Gaethje: Choque de Titanes por el Oro</p></div></a>""", unsafe_allow_html=True)
    with col_n3:
        st.markdown("""<a href="[https://www.dazn.com/es-MX/news/mma/la-casa-blanca-ya-huele-a-ufc-arranca-la-construccion-de-la-jaula-del-freedom-250/1tph2u2jt7z7nzu48cs89688b](https://www.dazn.com/es-MX/news/mma/la-casa-blanca-ya-huele-a-ufc-arranca-la-construccion-de-la-jaula-del-freedom-250/1tph2u2jt7z7nzu48cs89688b)" target="_blank" class="news-card" style="background-image: url('[https://cms-images.acc.indazn.com/di/library/DAZN_News/75/aa/ufc-freedom-250-topuria-vs-gaethje_rarhj63rmuf114nwefy7rmf0v.jpg?t=-2004902675&quality=80&w=750&h=422](https://cms-images.acc.indazn.com/di/library/DAZN_News/75/aa/ufc-freedom-250-topuria-vs-gaethje_rarhj63rmuf114nwefy7rmf0v.jpg?t=-2004902675&quality=80&w=750&h=422)');"><div class="news-overlay"><p class="news-title">Inicia la construcción del Octágono en la Casa Blanca</p></div></a>""", unsafe_allow_html=True)

    st.markdown("<br><hr style='border-color: #333;'><br>", unsafe_allow_html=True)
    
    # Rules and Trailer section
    col_rules, col_trailer = st.columns([1, 1])
    with col_rules:
        st.markdown("""
        <div class="custom-box" style="border-left-color: #DC2626;">
            <h2 style="color: #DC2626; font-size: 2.8rem; margin-top:0;">📝 REGLAS DE PUNTUACIÓN</h2>
    ...
    # Hype Room (Pre-fight quotes & facts)
    st.markdown("<h2 style='color: #ffffff; font-size: 3rem;'><span style='color:#D4AF37;'>🎙️</span> HYPE ROOM: LA PREVIA</h2>", unsafe_allow_html=True)
    col_h1, col_h2 = st.columns(2)
    with col_h1:
        st.markdown("""
...
# --- PICKS (PREDICCIONES) TAB ---
with t_picks:
    st.markdown("<h2 style='color: #ffffff; text-align:center; font-size: 3.5rem;'>🔥 PREDICCIONES OFICIALES</h2>", unsafe_allow_html=True)
    
    # Input area for nickname and league selection
    user_input = st.text_input("👤 INGRESA TU APODO PARA EL STREAM:", placeholder="Ej. El Especialista")
    user_clean = user_input.strip().title()
    
    league_option = st.selectbox("🤝 ¿DÓNDE QUIERES COMPETIR?", ["🌍 Ranking Global (Recomendado para el Directo)", "➕ Crear Liga Privada", "🔐 Unirse a Liga Existente"])
    league_name_clean, join_clave, create_clave, new_league_name = "GLOBAL", "", "", ""
    
    if league_option == "➕ Crear Liga Privada":
        col_nl, col_cl = st.columns(2)
        with col_nl: new_league_name = st.text_input("Nombre de Liga:")
        with col_cl: create_clave = st.text_input("Clave Secreta:")
        league_name_clean = new_league_name.strip().upper()
    elif league_option == "🔐 Unirse a Liga Existente":
        ligas_disp = df_ligas["nombre_liga"].tolist()
        if ligas_disp:
            col_sel, col_pass = st.columns(2)
            with col_sel: league_selection = st.selectbox("Selecciona Liga:", ligas_disp)
            with col_pass: join_clave = st.text_input("Contraseña:", type="password")
            league_name_clean = league_selection
        else: st.error("No hay ligas privadas aún.")

    if user_clean:
        st.markdown("---")
        
        # Check if user has already made picks for the main event to display brag button
        pred_main = df_predicciones[(df_predicciones["usuario"] == user_clean) & (df_predicciones["pelea_id"] == 1)]
        if not pred_main.empty:
            w_main = pred_main.iloc[0]["pred_winner"]
            m_main = pred_main.iloc[0]["pred_method"]
            r_main = pred_main.iloc[0]["pred_round"]
            
            whatsapp_brag_text = f"🥊 ¡Sellé mi cartilla para el UFC Freedom 250! Mi pronóstico estelar: {w_main} gana por {m_main} (Round {r_main}). 🔥 ¿Crees que sabes más que yo? Entra al directo de Cokemma y supérame aquí: {APP_URL}"
            whatsapp_brag_url = f"[https://api.whatsapp.com/send?text=](https://api.whatsapp.com/send?text=){urllib.parse.quote(whatsapp_brag_text)}"
            
            st.markdown(f"""
            <div style="background: linear-gradient(135deg, #10B981 0%, #047857 100%); padding: 25px; border-radius: 12px; text-align: center; margin-bottom: 30px; border: 2px solid #34D399; box-shadow: 0 8px 20px rgba(16, 185, 129, 0.3);">
                <h3 style="color: white; margin-top: 0; font-family: 'Bebas Neue', sans-serif; font-size: 2.8rem; letter-spacing: 1px;">✅ ¡CARTILLA GUARDADA CON ÉXITO!</h3>
                <p style="color: #ecfdf5; font-size: 1.2rem; margin-bottom: 20px; font-family: 'Montserrat', sans-serif;">Tus predicciones ya están en el sistema. ¡Desafía a tus amigos por WhatsApp y que arda el chat!</p>
                <a href="{whatsapp_brag_url}" target="_blank" style="text-decoration: none; display: inline-block; background-color: #ffffff; color: #047857; padding: 15px 30px; border-radius: 8px; font-weight: 800; font-family: 'Montserrat', sans-serif; font-size: 1.1rem; text-transform: uppercase; box-shadow: 0 4px 10px rgba(0,0,0,0.3); transition: transform 0.2s;">
                    📲 ALARDEAR MI PRONÓSTICO EN WHATSAPP
                </a>
            </div>
            """, unsafe_allow_html=True)
        
        # Form area for making picks
        with st.form("form_preds_ufc"):
            for _, row in df_peleas.iterrows():
                p_id = row["id"]
                # Look up existing prediction if any
                user_pred_existing = df_predicciones[(df_predicciones["usuario"] == user_clean) & (df_predicciones["pelea_id"] == p_id)]
                
                # Default selection values
                default_w, default_m, default_r = row["fighter_a"], OPTIONS_METHOD[-1], "Tarjetas (Decisión)" # Defaulting to decision
                if not user_pred_existing.empty:
                    default_w, default_m, default_r = user_pred_existing.iloc[0]["pred_winner"], user_pred_existing.iloc[0]["pred_method"], str(user_pred_existing.iloc[0]["pred_round"])

                ops_w = [row["fighter_a"], row["fighter_b"]]
                
                # Safe indexing for defaults
                idx_w = ops_w.index(default_w) if default_w in ops_w else 0
                idx_m = OPTIONS_METHOD.index(default_m) if default_m in OPTIONS_METHOD else (len(OPTIONS_METHOD)-1)
                ops_r = get_opciones_round(row["rondas_max"])
                idx_r = ops_r.index(default_r) if default_r in ops_r else (len(ops_r)-1)
                
                # Fetch localized fighter image URLs
                img_a_url = get_fighter_img_url(row["fighter_a"])
                img_b_url = get_fighter_img_url(row["fighter_b"])
                ...
                <div class='fight-card'>
                    ...
                    <div style='display:flex; justify-content:space-around; align-items:center;'>
                        <div style='width:35%;'>
                            <img src='{img_a_url}' class='fighter-img'>
                            <div class='fighter-name'>{row['fighter_a']}</div>
                        </div>
                        <div style='width:30%;' class='vs-text'>VS</div>
                        <div style='width:35%;'>
                            <img src='{img_b_url}' class='fighter-img'>
                ...
                # Disable inputs if fight is locked/played
                fight_locked = bool(row["jugado"])
                if fight_locked: st.markdown("<p style='text-align:center; color:#DC2626; font-weight:bold; font-size:1.2rem;'>🛑 PELEA FINALIZADA - PREDICCIONES BLOQUEADAS</p>", unsafe_allow_html=True)
                
                col1, col2, col3 = st.columns(3)
                with col1: st.selectbox("GANADOR", ops_w, index=idx_w, key=f"w_{p_id}", disabled=fight_locked)
                with col2: st.selectbox("MÉTODO", OPTIONS_METHOD, index=idx_m, key=f"m_{p_id}", disabled=fight_locked)
                with col3: st.selectbox("ROUND", ops_r, index=idx_r, key=f"r_{p_id}", disabled=fight_locked)
                st.markdown("<br><hr style='border-color: #333;'><br>", unsafe_allow_html=True)
                
            # Submit action with BOOM effect & SNOW on success
            if st.form_submit_button("🔒 CONFIRMAR MIS PREDICCIONES"):
                access_granted = True
                # Handle private league creation or joining logic
                if league_option == "➕ Crear Liga Privada":
                    if not new_league_name or not create_clave: st.error("Faltan datos de la liga (Nombre o Clave)."); access_granted = False
                    elif new_league_name.strip().upper() in df_ligas["nombre_liga"].str.upper().tolist(): st.error("Ya existe una liga con ese nombre."); access_granted = False
                    else:
                        df_ligas = pd.concat([df_ligas, pd.DataFrame([{"nombre_liga": league_name_clean, "clave_liga": create_clave, "creador": user_clean}])], ignore_index=True)
                        df_ligas.to_csv(LIGAS_FILE, index=False)
                elif league_option == "🔐 Unirse a Liga Existente" and ligas_disp:
                    stored_clave = df_ligas[df_ligas["nombre_liga"] == league_name_clean]["clave_liga"].values[0]
                    if str(join_clave) != str(stored_clave):
                        st.error("Contraseña incorrecta para unirse a la liga."); access_granted = False

                if access_granted:
                    # Save picks to predictions database
                    for _, row in df_peleas.iterrows():
                        p_id = row["id"]
                        if row["jugado"]: continue # Don't update predictions for locked fights
                        df_predicciones = df_predicciones[~((df_predicciones["usuario"] == user_clean) & (df_predicciones["pelea_id"] == p_id))]
                        new_pred_entry = {
                            "usuario": user_clean, 
                            "liga": league_name_clean, 
                            "pelea_id": p_id, 
                            "pred_winner": st.session_state[f"w_{p_id}"], 
                            "pred_method": st.session_state[f"m_{p_id}"], 
                            "pred_round": st.session_state[f"r_{p_id}"]
                        }
                        df_predicciones = pd.concat([df_predicciones, pd.DataFrame([new_pred_entry])], ignore_index=True)
                    df_predicciones.to_csv(PREDICCONES_FILE, index=False)
                    
                    # 💥 Visual confirmation & SNOW effect
...
with t_stats:
    ...
    if df_predicciones.empty:
        st.info("Aún no hay suficientes predicciones registradas para calcular las probabilidades de la comunidad.")
    else:
        # Loop through fights and display percentage breakdown
        for _, row in df_peleas.iterrows():
            f_a, f_b = row["fighter_a"], row["fighter_b"]
            preds_fight = df_predicciones[df_predicciones["pelea_id"] == row["id"]]
            
            if not preds_fight.empty:
                total_votes = len(preds_fight)
                votes_a = len(preds_fight[preds_fight["pred_winner"] == f_a])
                votes_b = len(preds_fight[preds_fight["pred_winner"] == f_b])
                
                pct_a = int((votes_a / total_votes) * 100) if total_votes > 0 else 0
                pct_b = 100 - pct_a if total_votes > 0 else 0
                
                # Method & Round breakdown display logic
                meth_vc = preds_fight["pred_method"].value_counts(normalize=True).mul(100).round().to_dict()
                fav_meth = max(meth_vc, key=meth_vc.get) if meth_vc else "N/A"
                
                # Community barometer bars display
                st.markdown(f"""
                <div style="background-color: #111; padding: 25px; border-radius: 12px; margin-bottom: 20px; border-left: 5px solid #D4AF37; box-shadow: 0 4px 10px rgba(0,0,0,0.5);">
                    <p style="color: #A1A1AA; font-size: 1.1rem; margin-bottom: 10px; text-transform: uppercase; letter-spacing: 2px; font-family: 'Bebas Neue', sans-serif;">{row['peso']} | Votos Totales: {total_votes}</p>
                    <div style="display: flex; justify-content: space-between; margin-bottom: 12px;">
                        ...
                        <span style="font-size: 1.2rem; color:#aaa; font-weight:600;">Comunidad predice: Gana {preds_fight['pred_winner'].mode().values[0]} por {fav_meth}</span>
...
with t_ranks:
    ...
    league_ops = ["GLOBAL"]
    if not df_ligas.empty: league_ops.extend(sorted(df_ligas["nombre_liga"].unique().tolist()))
    selected_league_filter = st.selectbox("🔍 Filtrar por Gimnasio (Liga):", league_ops).strip().upper()
    
    # Calculate and display leaderboard
    df_leaderboard_display = calculate_leaderboard(df_peleas, df_predicciones, selected_league_filter)
    if not df_leaderboard_display.empty: 
        st.dataframe(df_leaderboard_display, use_container_width=True, hide_index=True)
    else: 
        st.info("Aún no hay peleadores registrados haciendo predicciones en esta liga.")

# --- ODDS & ANALYSIS TAB (TALE OF THE TAPE) ---
with t_odds:
    ...
    # Select fight to analyze
    fight_list_for_odds = [f"{row['fighter_a']} vs {row['fighter_b']}" for _, row in df_peleas.iterrows()]
    selected_odds_fight = st.selectbox("🔍 Combate a analizar en Las Vegas:", fight_list_for_odds)
    
    if selected_odds_fight:
        # Fetch data for selected fighters
        f_a_odds_name, f_b_odds_name = selected_odds_fight.split(" vs ")
        img_a_odds, img_b_odds = get_fighter_img_url(f_a_odds_name), get_fighter_img_url(f_b_odds_name)
        
        # Display Tale of the Tape comparison
        col_img1, col_vs_div, col_img2 = st.columns([2, 1, 2])
        with col_img1: st.markdown(f"<div style='text-align:center;'><img src='{img_a_odds}' class='fighter-img' style='width:160px; height:160px; border-color:#333;'><h3 style='color:white; margin-top:10px; font-size: 2.5rem;'>{f_a_odds_name}</h3></div>", unsafe_allow_html=True)
        with col_vs_div: st.markdown("<h1 style='text-align:center; color:#D4AF37; margin-top: 40px; font-size: 4rem;'>VS</h1>", unsafe_allow_html=True)
        with col_img2: st.markdown(f"<div style='text-align:center;'><img src='{img_b_odds}' class='fighter-img' style='width:160px; height:160px; border-color:#333;'><h3 style='color:white; margin-top:10px; font-size: 2.5rem;'>{f_b_odds_name}</h3></div>", unsafe_allow_html=True)
        
        st.markdown("<br>", unsafe_allow_html=True)
        
        # Stats table display
        st.markdown(f"""
        <table style="width:100%; text-align:center; background: rgba(20,20,20,0.8); border-radius:12px; overflow:hidden; border: 1px solid #333; color: white;">
            <tr style="background-color:#111; color:#D4AF37; font-family:'Bebas Neue', sans-serif;">
                <td style="padding:15px; width:33%; font-size:2rem;">{get_stat_value(f_a_odds_name, 'record')}</td>
                <td style="padding:15px; width:33%; font-size:1.6rem; letter-spacing:1px; font-weight: 800;">RÉCORD</td>
                <td style="padding:15px; width:33%; font-size:2rem;">{get_stat_value(f_b_odds_name, 'record')}</td>
            </tr>
            <tr>
                <td style="padding:15px; border-bottom:1px solid #222; font-weight:600; font-size:1.2rem;">{get_stat_value(f_a_odds_name, 'altura')}</td>
                <td style="padding:15px; border-bottom:1px solid #222; color:#A1A1AA; font-family:'Bebas Neue', sans-serif; font-size:1.6rem; font-weight: 800;">ESTATURA</td>
                <td style="padding:15px; border-bottom:1px solid #222; font-weight:600; font-size:1.2rem;">{get_stat_value(f_b_odds_name, 'altura')}</td>
            </tr>
            <tr>
                <td style="padding:15px; font-weight:600; font-size:1.2rem;">{get_stat_value(f_a_odds_name, 'alcance')}</td>
                <td style="padding:15px; color:#A1A1AA; font-family:'Bebas Neue', sans-serif; font-size:1.6rem; font-weight: 800;">ALCANCE</td>
                <td style="padding:15px; font-weight:600; font-size:1.2rem;">{get_stat_value(f_b_odds_name, 'alcance')}</td>
            </tr>
        </table>
        """, unsafe_allow_html=True)
        
        # Odds display styling
        odds_a_val, odds_b_val = get_stat_value(f_a_odds_name, 'odds'), get_stat_value(f_b_odds_name, 'odds')
        color_a_class = "odds-fav" if "-" in str(odds_a_val) else "odds-dog"
        color_b_class = "odds-fav" if "-" in str(odds_b_val) else "odds-dog"
        
        st.markdown("<br>", unsafe_allow_html=True)
        col_odds1, col_odds2 = st.columns(2)
        with col_odds1:
            st.markdown(f"<div class='odds-box'><p style='color:#A1A1AA; margin:0; font-weight:600; font-size:1.2rem; text-transform:uppercase;'>{f_a_odds_name}</p><p class='{color_a_class}' style='margin:0; font-size:3rem;'>{odds_a_val}</p></div>", unsafe_allow_html=True)
        with col_odds2:
            st.markdown(f"<div class='odds-box'><p style='color:#A1A1AA; margin:0; font-weight:600; font-size:1.2rem; text-transform:uppercase;'>{f_b_odds_name}</p><p class='{color_b_class}' style='margin:0; font-size:3rem;'>{odds_b_val}</p></div>", unsafe_allow_html=True)

# --- ADMIN TAB (LOCKED WITH PASSWORD) ---
with t_admin:
    st.markdown("<h2 style='color: #DC2626; font-size: 3.5rem;'>🔒 MESA DE CONTROL (OFFICIALS ONLY)</h2>", unsafe_allow_html=True)
    if st.text_input("Ingresa la credencial de acceso para desbloquear:", type="password") == ADMIN_PASSWORD:
        with st.form("admin_fight_closer_form"):
            for idx, row in df_peleas.iterrows():
                f_a_adm, f_b_adm = row['fighter_a'], row['fighter_b']
                st.write(f"**Administer Results: {f_a_adm} vs {f_b_adm}**")
                # Pre-defined options logic
                ops_w_adm = [f_a_adm, f_b_adm, "Empate/No Contest"]
                ops_r_adm = get_opciones_round(row["rondas_max"])
                
                c1_a, c2_a, c3_a, c4_a = st.columns([2, 1, 1, 1])
                with c1_a: winner_res = st.selectbox("Ganador Real", ops_w_adm, index=ops_w_adm.index(row['res_winner']) if row['res_winner'] in ops_w_adm else 0, key=f"rw_{row['id']}")
                with c2_a: method_res = st.selectbox("Método Real", OPTIONS_METHOD, index=OPTIONS_METHOD.index(row['res_method']) if row['res_method'] in OPTIONS_METHOD else (len(OPTIONS_METHOD)-1), key=f"rm_{row['id']}")
                with c3_a: round_res = st.selectbox("Round Real", ops_r_adm, index=ops_r_adm.index(str(row['res_round'])) if str(row['res_round']) in ops_r_adm else (len(ops_r_adm)-1), key=f"rr_{row['id']}")
                with c4_a: is_played = st.checkbox("¿Pelea Oficialmente Cerrada?", value=row["jugado"], key=f"rj_{row['id']}")
                st.markdown("---")
            if st.form_submit_button("💥 CERRAR RESULTADOS DE LA NOCHE & ACTUALIZAR RÁNKINGS"):
                # Save actual fight results
                for idx, row in df_peleas.iterrows():
                    p_id_a = row['id']
                    df_peleas.at[idx, "res_winner"] = st.session_state[f"rw_{p_id_a}"]
                    df_peleas.at[idx, "res_method"] = st.session_state[f"rm_{p_id_a}"]
                    df_peleas.at[idx, "res_round"] = st.session_state[f"rr_{p_id_a}"]
                    df_peleas.at[idx, "jugado"] = bool(st.session_state[f"rj_{p_id_a}"])
                df_peleas.to_csv(PELEAS_FILE, index=False)
                st.success('Resultados Guardados Oficialmente. Ránkings actualizados en tiempo real.')
                time.sleep(1)
                st.rerun()
...
<div style="text-align: center; margin-top: 60px; padding: 25px; border-top: 1px solid #333;">
    <p style="color: #666; font-size: 1.1rem; font-weight:600;">UFC Freedom 250 Predictions © 2026 | Desarrollado por <a href="{DEVELOPER_URL}" target="_blank" style="color:#D4AF37; text-decoration:none; font-family:'Bebas Neue', sans-serif; font-size:1.8rem; letter-spacing:1px;">{DEVELOPER_TIKTOK}</a></p>
</div>
""", unsafe_allow_html=True)
